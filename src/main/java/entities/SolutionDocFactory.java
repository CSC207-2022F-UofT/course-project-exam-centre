...
public class SolutionDocFactory {
     ...
     */
    public SolutionDocument create(String name, String id, Course course, User user, String score, String testID) {
        return new SolutionDocument(name, id, course, user, score, testID);
    }
}
