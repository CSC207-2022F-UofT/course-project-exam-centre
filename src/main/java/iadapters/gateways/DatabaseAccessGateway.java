...
import iadapters.gateways.models.*;
import usecases.course.register.CRegisterDsGateway;
import usecases.course.register.CRegisterDsRequestModel;
import usecases.course.updatemembers.UpdateCMemDsGateway;
import usecases.submessage.SubDBMessDsGateway;
import usecases.submessage.SubDBMessDsRequestModel;
import usecases.doc.submitsolution.SubmitSDocDsGateway;
import usecases.doc.submitsolution.SubmitSDocDsRequestModel;
import usecases.doc.submittest.SubmitTDocDsGateway;
import usecases.doc.submittest.SubmitTDocDsRequestModel;
import usecases.doc.voteonsolution.VoteSDocDsGateway;
import usecases.doc.voteonsolution.VoteSDocDsRequestModel;
import usecases.state.update.UpdateStateDsGateway;
import usecases.user.login.LoginDsGateway;
import usecases.user.register.URegisterDsGateway;
import usecases.user.register.URegisterDsRequestModel;
